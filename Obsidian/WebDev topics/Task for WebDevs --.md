    ...
    projects-
  - First project
      - computational model training on other devices using crypto wallet transacrtion  - you can use docker using images 
      - ai/ml model training on the other devices
      - renders on other devices 
      - you can use other computer's graphic  card and high end computations    architecture
